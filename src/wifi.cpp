...
void wifi_init_sta(const char* ssid, const char* pwd)
{
   ...
   strncpy((char*)wifi_config.sta.ssid, ssid, sizeof(wifi_config.sta.ssid)/sizeof(wifi_config.sta.ssid[0]));
   strncpy((char*)wifi_config.sta.password, pwd, sizeof(wifi_config.sta.password)/sizeof(wifi_config.sta.password[0]));
